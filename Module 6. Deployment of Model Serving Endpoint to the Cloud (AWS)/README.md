...
>I upload my model to our created "testepambucket" in "model_artifacts" folder. You can find it in `models` folder(I have added this folder in case you want to download the model file and reproduce my experiment. This folder is not required in this project and is not used in any way in the code)
